...
<div class="card">
    <div class="card-body">
        ...
        <a href="{{ route('tahun-ajaran.create') }}" class="btn btn-sm text-white font-weight-bold position-absolute px-3" style="top: .7rem; right: 1rem; background-color: #3bae9c">Tambah
            Tahun Ajaran</a>
        <table class="table">
            <thead>

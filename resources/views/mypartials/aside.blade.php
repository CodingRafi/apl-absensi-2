  ...
  <ul class="nav">
          ...
          <li class="nav-item">
            <form action="{{ route('tahun-ajaran.index') }}">
              ...
              <button class="nav-link {{ Request::is('tahun-ajaran') ? 'active' : '' }}"
                style="background-color: #3bae9c; border: none; min-width: 150px;text-transform: capitalize;">Tahun
                Ajaran</button>
            </form>
          </li>
          @endif
          ...
          <li class="nav-item">
            <form action="{{ route('status-kehadiran.index') }}" method="get">
              ...
              <button class="nav-link {{ Request::is('status-kehadiran') ? 'active' : '' }}"
                style="background-color: #3bae9c; border: none; min-width: 150px;text-transform: capitalize;">Status
                kehadiran</button>
            </form>
          </li>
          @endif
    ...
    <li class="nav-item">
      <a class="nav-link {{ Request::is('users*') ? 'active' : '' }}{{ Request::is('siswa') ? 'active' : '' }}"
        data-toggle="collapse" href="#data-user" aria-expanded="false" aria-controls="data-user">

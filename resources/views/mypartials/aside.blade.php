    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            <form action="/agenda" method="get">
                @include('mypartials.tahunajaran')
                <button class="nav-link {{ Request::is('dashboard') ? 'active' : '' }}" style="background-color: #ffffff; border: none; min-width: 200px"><i class="bi bi-calendar-week menu-icon"></i> Agenda</button>
            </form>
        </li>
    </ul>
</nav>
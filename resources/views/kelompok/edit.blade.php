        ...
        <form action="{{ route('kelompok.update', [$kelompok->id]) }}" method="POST">
            ...
            <div class="mt-3 mb-3">
                ...
                <input type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" id="nama"
                    placeholder="Masukan nama kelompok" value="{{ $kelompok->nama, old('nama') }}">
                @error('nama')
            ...
            <div class="mt-3 mb-3">
                ...
                <input type="time" class="form-control @error('jam_masuk') is-invalid @enderror" name="jam_masuk"
                    id="jam_masuk" value="{{ $kelompok->jam_masuk, old('jam_masuk') }}">
                @error('jam_masuk')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="mt-3 mb-3">
                ...
                <input type="time" class="form-control @error('jam_pulang') is-invalid @enderror" name="jam_pulang"
                    id="jam_pulang" value="{{ $kelompok->jam_pulang, old('jam_pulang') }}">
                @error('jam_pulang')
                <div class="invalid-feedback">
                    {{ $message }}
                </div>
            ...
            <div class="mb-3">
                ...
                <select class="fstdropdown-select @error('gurus') is-invalid @enderror" name="gurus[]" id="gurus"
                    style=" font-size: 15px; height: 6.5vh;" multiple>

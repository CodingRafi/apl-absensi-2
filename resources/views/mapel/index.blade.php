...
<div class="card">
    <div class="card-body">
        ...
        <form action="{{ route('mapel.create') }}" method="get">
            ...
            <button class="btn btn-sm text-white position-absolute px-3"
                style="top: .7rem; right: 1rem; background-color: #3bae9c;border-radius: 5px;font-weight: 500;">Tambah</button>
        </form>
        @endif
        <table class="table">
            <thead>
                ...
                <tr class="text-center">
                    ...
                    <td>
                        ...
                        <button type="submit" class="btn btn-sm btn-danger"
                            onclick="deleteData('{{ route('mapel.destroy', [$mapel->id]) }}')"

...
function setFstDropdown() {
    ...
    function createDropdown(select) {
        ...
        if (select.multiple) {
            ...
            selectAll.textContent = "Pilih Semua Mata Pelajaran";
    ...
    function changeMultipleSelect(select, event, dd, selectAll, opened) {
        ...
        selectAll.textContent = selectAll.selected ? "Batal" : "Pilih Semua Mata Pelajaran";
    }
    ...
    function selectAllOptions(event) {
        ...
        initNewEvent("change", select);
        event.target.textContent = !selected ? "Pilih Semua Mata Pelajaran" : "Batal";
        ...
        if (select.dataset["opened"] == null || select.dataset["opened"] != "true") {
            ...
            if (select.multiple) {
                ...
                if (count != 1 && count != jumlahKomli) {
                    ...
                    text = "Memilih Semua Mata Pelajaran";
                } else {
                    sOption.textContent;
                }
